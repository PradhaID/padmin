...
<?php
    ...
    if (isset($_SERVER["HTTP_REFERER"]) && !strpos($_SERVER["HTTP_REFERER"],$_SERVER['HTTP_HOST'])){
        $sumber=$_SERVER["HTTP_REFERER"];
    }
?>
<?php $func->kunjungan($_SERVER["REMOTE_ADDR"],$sumber,$_SERVER['REQUEST_URI'],date('Y-m-d')); ?>
...
<div id="layout">
	<div id="header">
    	<div class="left">
            <img src="<?php echo $dir->rootDir().$dir->temaDir(); ?>/img/logo.png" align="left" style="margin-right:-10px;-webkit-border-radius: 0;-khtml-border-radius: 0;-moz-border-radius: 0;border-radius: 0;-moz-box-shadow: none;-webkit-box-shadow: none;box-shadow: none;">
