...
<META NAME="geo.placename" CONTENT="Linggarjati">
...
<meta property="og:street-address" content="Jl. Linggarjati no.4" />
<meta property="og:locality" content="Cilimus" />
...
<meta property="og:site_name" content="www.hotelayonglinggarjati.com" />
<meta property="og:image" content="<?php echo $dir->rootDir();?>pcontent/upload/e2c825e7b704dc71809f609e703f85e2.png" />
...
<div id="fl_menu">
	...
	<div class="menu">
    	<div class="fl_content"><div id="map" style="width:400px; height:300px"></div></div>
    </div>
</div>
<?php
...
?>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAnZwg6SSSIMTYV4EgZtP0vh-_i0TLSp_E&sensor=false"></script>
<script type="text/javascript" src="<?php echo $dir->rootDir()."pincludes/js/map.js"; ?>"></script>
<script type="text/javascript" src="<?php echo $dir->rootDir()."pincludes/js/floatMenu.js"; ?>"></script>
<div id="layout">
	<div id="header">
    	<div class="left">
			<img src="<?php echo $dir->rootDir();?>pcontent/upload/e2c825e7b704dc71809f609e703f85e2.png" align="left" style="margin-right:5px;">
