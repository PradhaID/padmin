...
?>
<form name="kategori" id="kategori" method="post" action="<?php echo $dir->modulDir();?>/tambah-kategori-pop.php">
<table width="300">
    <tr>
    	<td>
    ...
    <tr>
        ...
        <input type="button" name="btnTutup" id="btnTutup" value="Tutup" onclick="tutupKategori();" />
