...
include ("../class.php");
?>
<img src="css/images/question.png" align="left" /> <h2 style="padding-top:3px;">&nbsp; Data Soal <span style="font-size:12px;">| <a href="<?php echo '?halaman=p-modul&path='.$dir->path().'&target=';?>tambah-soal.php">Tambah Soal</a></span></h2>
...
<table class="data" width="100%" cellpadding="0" cellspacing="0">
	<thead>
    	<tr>
            ...
            <td align="center" width="25%">Deskripsi Soal</td>
            <td align="center" width="10%">Waktu</td>
